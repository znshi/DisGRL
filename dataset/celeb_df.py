...
class CelebDF(AbstractDataset):
    ...
    def __get_images(self, ids, balance=False):
        ...
        # Celeb-synthesis
        for _ in ids[2]:
            #fake.extend(glob(join(self.root, 'Celeb-synthesis', 'images', _, '*.jpg')))
